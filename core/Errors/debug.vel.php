...
<body class="bg-gray-900 text-gray-100 font-sans min-h-screen flex flex-col">
    <div class="bg-red-600 py-4 px-6 shadow-lg">
        <div class="max-w-7xl mx-auto text-center">
            <h1 class="text-2xl font-bold">
                <span class="bg-black bg-opacity-20 px-3 py-1 rounded"><?= $code ?></span>
                <span class="ml-3"><?= $message ?></span>
            </h1>
        </div>
    </div>

    <div class="max-w-7xl mx-auto w-full px-6 py-8 error-container">
        <?php if (!empty($file)): ?>
        <div class="mb-8">
            ...
            <div class="code-block mb-4">
                <div class="p-4 text-gray-400 text-sm">
                    <span class="text-red-400"><?= $file ?></span> on line <span class="text-yellow-400"><?= $line ?></span>
                </div>
